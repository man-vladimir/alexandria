...
RSpec.describe 'Authors', type: :request do
  ...
  describe 'GET /api/authors/:id' do
    context 'with existing resource' do
      ...
      it 'receives the Pat Shaughnessy author as JSON' do
  ...
  describe 'POST /api/authors' do
    ...
    context 'with valid parameters' do
      let(:params) do
        attributes_for(:author, given_name: 'Pat', family_name: 'Shaughnessy')
      end
    ...
    context 'with invalid parameters' do
      let(:params) do
        attributes_for(:author, given_name: '', family_name: '')
      end
      ...
      it 'receives the error details' do
        expect(json_body['error']['invalid_params']).to eq(
          {'family_name'=>["can't be blank"], 'given_name'=>["can't be blank"]}
        )
      end
  ...
  describe 'PATCH /api/authors/:id' do
    ...
    context 'with valid parameters' do
      ...
      it 'updates the record in the database' do
        expect(Author.first.given_name).to eq 'Patch'
      end
    end
    context 'with invalid parameters' do
