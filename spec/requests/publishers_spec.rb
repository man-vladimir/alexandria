...
RSpec.describe 'Publishers', type: :request do
  ...
  describe 'GET /api/publishers/:id' do
    context 'with existing resource' do
      ...
      it "receives the O'Reilly publisher as JSON" do
  ...
  describe 'POST /api/publishers' do
    ...
    context 'with valid parameters' do
      let(:params) do
        attributes_for(:publisher, name: 'Reilly')
      end
      ...
      it 'receives the newly created resource' do
        expect(json_body['data']['name']).to eq 'Reilly'
      end
  ...
  describe 'PATCH /api/publishers/:id' do
    ...
    context 'with valid parameters' do
      ...
      it 'updates the record in the database' do
        expect(Publisher.first.name).to eq 'Reilly'
      end
    end
    context 'with invalid parameters' do
      let(:params) {{ name: ''}}
